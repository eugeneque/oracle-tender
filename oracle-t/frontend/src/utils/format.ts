...
// никакого решения модели за ним нет. Решение модели — отдельная метка «Наша тематика»
// (`tenders.ai_relevant`, до 18.09.2026 — «Подобрано ИИ»), и две разные вещи под похожими
// названиями путали работу.
 ...
 * («Наша тематика»): первое — состояние торгов, второе — мнение системы, а этап — наша работа.
 */
