    ...
    {summary.wins_only_data && (
      <div className="mb-4 flex gap-2 rounded-lg border border-amber-500/25 bg-amber-500/[0.07] px-3 py-2.5">
        ...
        <p className="text-[11px] leading-relaxed text-amber-200/90">
          ...
          «заявка подана», а полностью — кнопкой «Обновить из rusprofile» на вкладке
          «Профили компаний»: сайт показывает и закупки, которые компания не выиграла.
        </p>
      </div>
    )}
    </>
  ...
  return (
    <div>
      <p className="mb-4 text-xs leading-relaxed text-zinc-500">
        ...
        AI-оценки. Полнее всего её даёт rusprofile.ru под учётной записью (кнопка «Обновить из
        rusprofile» у основной компании): там видны и победы, и закупки, которые компания не
        выиграла. Победы также выгружаются из реестра контрактов ЕИС по ИНН, а проигрыши по
        нашим тендерам выводятся из пайплайна: закупка с отметкой «заявка подана» завершилась,
        контракт достался не нам. Что не покрылось и этим, вносится вручную.{" "}
